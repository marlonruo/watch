!function(e){void 0==e.fn.ajaxForm&&e.getScript("js/form.js");
    var a = {};
    a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function(t) {
        ...
        function h(t, r, o, s) {
            ...
            u.change(function() {
                ...
                if (this.files) {
                    for (g = 0; g < this.files.length; g++) i.push(this.files[g].length);
        ...
        function v(t, o, s, l, n, d) {
            var h = {
                ...
                success: function(a, r, i) {
                    ...
                    n.responses.push(a), s.progressbar.width("100%"), o.showProgress && (s.progressbar.html("100%"), s.progressbar.css("text-align", "center")), s.abort.hide(), o.onSuccess.call(this, l, a, i, s), o.showStatusAfterSuccess ? (o.showDone ? (s.done.hide(), s.done.click(function() {
        ...
        var w = e.extend({
            ...
            dragDropStr: "<span><b>Arrastra tus imagenes hasta aqui</b></span>",
            uploadStr: "Subir",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "Delete",
        ...
        e(b).addClass(w.uploadButtonClass),
            function F() {
                if (e.fn.ajaxForm) {
                    if (w.dragDrop) {
                        var a = e('<div class="' + w.dragDropContainerClass + '" style="vertical-align:top;"></div>').width(360);
                        e(C).append(a), e(a).append(b), e(a).append(e('<div style="position:absolute; top:12px; left:120px; font-family:Arial">'+w.dragDropStr+'</div>')), o(C, w, a)
                    } else e(C).append(b);
